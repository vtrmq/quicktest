...
import { Title, NoneData, LinkBack } from '$lib/components';
import { filtrarParametros, typeActivity } from '$lib/utils';
...
<div class="container-teachers-registrations">
  ...
  <div class="wr-title">
    <LinkBack href="/teacher/topic/assign?{root}">Temas/Asignaturas</LinkBack>
            ...
            <div class="box-course">
              <div>
                ...
                <div class="info-p">
                  ...
                  <span>Total: {row.nota}</span>
                </div>
              </div>
              <a class="box-link-subject" href="/teacher/topic/assign?{root}">{@html sendHorizontal}</a>
            </div>
          </div>
        </div>
      {/each}
