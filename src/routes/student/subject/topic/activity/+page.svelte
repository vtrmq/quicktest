<script lang="ts">
    ...
    const root = filtrarParametros(page.url.href, [
        "teacherId",
        "courseId",
        "subjectId",
    ]);
...
<div class="container-topics">
    ...
    {#if result.activities.length !== 0}
                                        ...
                                        {#if row.answered === 0 && isDateEnd(row.date_end)}
                                            <a
                                                ...
                                                href="/student/subject/topic/activity/info?teacherId={row.teacher_id}&courseId={result
                                                    ...
                                                    .subject
                                                    .subject_id}&topicId={result
                                                    .topic
                                                    .topic_id}&activityId={row.activity_id}&origin=activity"
                                                >Ver detalles</a
                                            >
        ...
        <div
            ...
            class:visible={result.activities.length !== 0 && notaTotal !== 0}
        >
