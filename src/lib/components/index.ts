...
export { default as LinkBtn } from './ui/LinkBtn.svelte';
...
export { default as AddImage } from './ui/AddImage.svelte';
export { default as BtnX } from './ui/BtnX.svelte';
export { default as PointNum } from './ui/PointNum.svelte';
